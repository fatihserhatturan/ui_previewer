<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-8">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 h-[90vh]">
      <!-- Kod Giriş Bölümü -->
      <div
        class="bg-gradient-to-br from-white/40 to-white/30 rounded-3xl border-2 border-blue-200 flex flex-col overflow-hidden backdrop-blur-md">
        <div class="h-[72px] px-6 flex items-center backdrop-blur-sm bg-white/40 border-b-2 border-blue-200">
          ...
          <div class="ml-auto flex space-x-4">
            <div class="ml-auto flex space-x-4">
              ...
              <button @click="toggleFramework"
                class="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 hover:bg-blue-500 text-gray-600 hover:text-white transition duration-300 shadow-sm hover:shadow-md border border-gray-300 hover:border-blue-500">
        ...
        <div class="flex-1 p-3 relative">
          <div class="absolute inset-0 overflow-auto">
            ...
            <pre
              class="w-full h-full p-4 bg-gradient-to-br from-white/40 to-white/30 font-mono text-sm text-gray-700 rounded-2xl m-0 absolute top-0 left-0"><code ref="highlightCode" class="html hljs language-html" v-html="highlightedCode"></code></pre>
          </div>
        </div>
      </div>
